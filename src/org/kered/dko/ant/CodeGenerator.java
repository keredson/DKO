...
public class CodeGenerator extends Task {
	...
	/**
	 * The path to the JSON file (generated with {@link org.kered.dko.ant.SchemaExtractor}) containing your database schema.
	 * @param s
	 */
...
//
	...
	/**
	 * Path to the optional enums JSON file (which would be generated by {@link org.kered.dko.ant.SchemaExtractor}).
	 * @param s
	 */
