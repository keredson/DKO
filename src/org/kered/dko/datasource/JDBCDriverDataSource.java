...
/**
 * When (usually older) JDBC drivers don't offer a DataSource implementation this class will give you one.
 *
 * @author Derek Anderson
 */
public class JDBCDriverDataSource
    ...
    public JDBCDriverDataSource(final String url, final String username, final String password) {
	this.type = null;
	this.url = url;
    ...
    public JDBCDriverDataSource(final Constants.DB_TYPE type, final String url, final String username, final String password) {
	this.type = type;
	this.url = url;
	this.username = username;
	this.password = password;
    ...
    @Override
    public void setLogWriter(final PrintWriter arg0)
	throws SQLException
    {
	// TODO Auto-generated method stub
    ...
    @Override
    public void setLoginTimeout(final int arg0)
	throws SQLException
    {
	// TODO Auto-generated method stub
