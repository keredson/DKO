...
public class TestBugzilla extends TestCase {
	...
	public void test12() throws SQLException {
		...
		o.setAssignedToFK(Profile.ALL.get(Bug.BUG_ID.eq(1)));
		o.setBugSeverity("");
		o.setBugStatus("NEW");
		o.setDeltaTs(new Timestamp(0));
		o.setOpSys("");
		o.setPriority("");
		o.setProductIdFK(Product.ALL.first());
		o.setRepPlatform("");
		o.setReporterFK(Profile.ALL.first());
		o.setVersion("");
		o.setComponentIdFK(Component.ALL.first());
	...
	public void test14() throws SQLException {
		System.out.println(Bug.ALL.get(Bug.BUG_ID.eq(1)).getAssignedToFK().getRealname());
	}
	public void test15() throws SQLException {
		Profile assignee = Bug.ALL.get(Bug.BUG_ID.eq(1)).getAssignedToFK();
	...
	public void test20() throws SQLException {
		for (Bug o : Bug.ALL.with(Bug.FK_PRODUCT, Product.FK_CLASSIFICATION)
			...
			System.out.println(o +" : "+ o.getProductIdFK().getClassificationIdFK());
		}
	}
