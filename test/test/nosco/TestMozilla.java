...
import db.bugzilla3.Classification;
import db.bugzilla3.Product;
import db.bugzilla3.Profile;
...
public class TestMozilla extends TestCase {
	...
	public void test11() throws SQLException {
		for (Product o : Product.ALL.top(10)) {
			System.out.println(o.getClassificationIdFK());
		}
	}
	...
	public void test14() throws SQLException {
		System.out.println(Bug.ALL.get(Bug.BUG_ID.eq(212657)).getAssignedToFK().getRealname());
	}
	
	public void test15() throws SQLException {
		Profile assignee = Bug.ALL.get(Bug.BUG_ID.eq(212657)).getAssignedToFK();
	...
	public void test16() throws SQLException {
		for (Bug o : Bug.ALL.with(Bug.FK_ASSIGNED_TO_PROFILE).top(50)) {
			System.out.println(o +" : "+ o.getAssignedToFK());
		}
	}
	...
	public void test18() throws SQLException {
		...
		for (Bug o : Bug.ALL.with(Bug.FK_REPORTER_PROFILE).where(Profile.REALNAME.eq("Derek Anderson"))) {
			System.out.println(o +" : "+ o.getReporterFK().getRealname());
			++c;
		}
		assertTrue(c > 0);
	}
	...
	public void test19() throws SQLException {
		for (Bug o : Bug.ALL.with(Bug.FK_PRODUCT).with(Bug.FK_ASSIGNED_TO_PROFILE).where(Product.ID.eq(1)).limit(10)) {
			System.out.println(o.getBugId() +" : "+ o.getProductIdFK().getName() +" : "+ o.getAssignedToFK().getRealname());
		}
	}
	...
	public void test20() throws SQLException {
		for (Bug o : Bug.ALL.with(Bug.FK_PRODUCT, Product.FK_CLASSIFICATION)
			...
			System.out.println(o.getBugId() +" : "+ o.getProductIdFK().getName() +" : "+ o.getProductIdFK().getClassificationIdFK().getName());
		}
	}

	public void test21() throws SQLException {
		for (Bug o : Bug.ALL.with(Bug.FK_REPORTER_PROFILE).with(Bug.FK_ASSIGNED_TO_PROFILE).top(10)) {
			System.out.println(o.getBugId() +" : "+ o.getReporterFK().getRealname() +" : "+ o.getAssignedToFK().getRealname());
		}
	}
	...
	public void test22() throws SQLException {
		for (Bug o : Bug.ALL.with(Bug.FK_REPORTER_PROFILE).with(Bug.FK_ASSIGNED_TO_PROFILE).top(10)
			...
			Profile reporterProfile = o.getReporterFK();
			Profile qaContactProfile = o.getAssignedToFK();
